...
def data_type_check_pkl(file_path):
    """
    Lee un archivo PKL y genera un resumen del DataFrame que incluye la proporción de valores nulos y no nulos,
    el tipo de datos y la cantidad total de nulos por columna.

    Parámetros:
    file_path (str): La ruta del archivo PKL a ser leído.
